...
4. resolve_gate resolve gate fixture/GitHub read/dry-run/actual apply path
5. review/02 review + techlead artifact validation/publication path
6. design/04 design + design chief routing/publication path
7. fix_dispatch/06/07 autofix patch dispatch/merge/push guard path
8. reentry reentry record/validation path
