...
def build_cluster_prompt(design_inventory: dict[str, Any], design_context: dict[str, Any]) -> str:
    return (
        ...
        "Return stage03-design-clusters.v1 JSON.\n"
...
def validate_design_clusters(
    ...
    evidence = validate_inspection_evidence(clusters, repo_path, "stage03 design clusters")
    ...
    out=dict(clusters); out["schema_version"]="stage03-design-clusters.v1"; out["clusters"]=items; out["cluster_count"]=len(items); out["inspection_evidence"]=evidence
    return out
