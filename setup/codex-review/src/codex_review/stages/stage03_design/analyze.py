...
def validate_cluster_analysis(
    ...
    evidence = validate_inspection_evidence(analysis, repo_path, "stage03 cluster analysis")
    ...
    out=dict(analysis); out["schema_version"]="stage03-cluster-analysis.v1"; out["analyses"]=analyses; out["inspection_evidence"]=evidence
    return out
