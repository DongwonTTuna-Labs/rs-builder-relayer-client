...
pub use deposit_wallet::{
    ...
    AmbiguousCandidate, AmbiguousCandidateReport, DepositWalletAddress, DepositWalletCall,
    DepositWalletContractConfig, DepositWalletCreateRequest, DepositWalletDeploymentPolicy,
    DepositWalletDeploymentStatus, DepositWalletDryRunEvidence, DepositWalletIdentityConfig,
    DepositWalletOwner, DepositWalletReadiness, DepositWalletRelayerClient,
    DepositWalletRelayerUrl, DepositWalletRequestContext, DepositWalletSubmitReceipt,
    DepositWalletTransactionReceipt, DryRunCallSummary, IdentityConfigSummary, IdentityOverlap,
    InMemoryMutationIntentStore, IntentGatedClient, IntentReconcileOutcome,
    MutationIntentAuditArtifact, MutationIntentLease, MutationIntentRecord, MutationIntentStatus,
    MutationIntentStore, OwnerMutationRegistry, ReconciliationDecision, ReconciliationEvidence,
    ReconciliationSummary, RelayerAuthIdentity, RelayerKeyAuth, RelayerMutationMode,
    RelayerMutationOperation, RelayerMutationPermit, RelayerPollOutcome, RelayerPollPolicy,
    RelayerReadPermit, RelayerSubmitOutcome, RelayerSubmitResponse, RelayerTransactionState,
    TryBeginOutcome, WalletNonceRequest,
