...
- Relayer get transaction: `https://docs.polymarket.com/api-reference/relayer/get-a-transaction-by-id`
  - current official polling response reference; re-check before claiming
